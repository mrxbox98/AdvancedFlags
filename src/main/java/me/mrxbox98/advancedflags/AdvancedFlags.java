...
public final class AdvancedFlags extends JavaPlugin implements LogHelper {
    ...
    public static ParticleList_1_8 particles;
    
    public static AdvancedPredicate playerPredicate = new AdvancedPredicate();
